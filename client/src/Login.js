...
function Login() {
    ...
    return (
        <Box pb="15px">
			<Button onClick={onOpen} variantColor="orange" size="lg" fontSize="xl" pos="absolute" right="15px">Log in</Button>
  ...
  onClose={onClose}
			>
				...
				<ModalContent>
					...
					<ModalFooter>
					    <Link href="https://chakra-ui.com" isExternal position="relative" pr="115px" pl="100px">
                        Continue as a guest <Icon name="external-link" mx="2px" />
                        </Link>
					</ModalFooter>
				</ModalContent>
			</Modal>
