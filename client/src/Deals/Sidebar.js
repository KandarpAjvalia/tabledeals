	...
	return (
		<Box maxW="250px" boxShadow="xl" bg="blue.300">
			<Stack spacing={2} bg="blue.300" pt="50px">
				<Button textAlign="left" bg="blue.300" color="white"><Heading as="h2" fontSize="18px">Home
			</Heading></Button>
				<Button textAlign="left" bg="blue.300" color="white"><Heading as="h2" fontSize="18px">Deals
			</Heading></Button>
				<Button textAlign="left" bg="blue.300" color="white"><Heading as="h2" fontSize="18px">Home
			Restaurants</Heading></Button>
				<Button bg="blue.300" color="white"><Heading as="h2" fontSize="18px">
			Map</Heading></Button>
			</Stack>
